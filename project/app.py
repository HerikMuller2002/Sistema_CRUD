...
# objeto app
app = dash.Dash(__name__,suppress_callback_exceptions=True, external_stylesheets=[dbc.themes.BOOTSTRAP,'https://fonts.googleapis.com/css2?family=Roboto:wght@300;700&display=swap',"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css",login.login_style(), admin.admin_style()])
